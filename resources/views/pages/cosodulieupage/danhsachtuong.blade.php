    ...
    <div class="tab-content" id="v-pills-tabContent">
      <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
            <div class="tier-group">
                ...
                <a class="characters-item c4" href="/champions/jhin"><div  class="character-wrapper"><img class="character-icon" src="https://rerollcdn.com/characters/Skin/3/Jhin.png" alt="Jhin"></div>
                    <div class="row popup-info">
                      <div class="col-md-3 col-3 info">
                ...
                <a class="characters-item c4" href="/champions/kayle"><div class="character-wrapper"><img class="character-icon" src="https://rerollcdn.com/characters/Skin/3/Kayle.png" alt="Kayle"></div>
                <div class="row popup-info">
                      <div class="col-md-3 col-3 info">
                      ...
                      <div class="col-md-12 item">
                        <div>Item:</div>
                        <img class="character-icon" src="https://rerollcdn.com/items/GuardianAngel.png" alt="Guardian Angel"> 
                        <img class="character-icon" src="https://rerollcdn.com/items/GuinsoosRageblade.png" alt="Guinsoo's Rageblade">
                        <img class="character-icon" src="https://rerollcdn.com/items/RapidFirecannon.png" alt="Rapid Firecannon">
                      </div>        

                    </div>
              </a>
                <a class="characters-item c5" href="/champions/lulu"><div class="character-wrapper"><img class="character-icon" src="https://rerollcdn.com/characters/Skin/3/Lulu.png" alt="Lulu"></div>
                <div class="row popup-info">
                      <div class="col-md-3 col-3 info">
                      ...
                      <div class="col-md-12 item">
                        <div>Item:</div>
                        <img class="character-icon" src="https://rerollcdn.com/items/SpearofShojin.png" alt="Spear of Shojin">
                        <img class="character-icon" src="https://rerollcdn.com/items/SpearofShojin.png" alt="Spear of Shojin">
                        <img class="character-icon" src="https://rerollcdn.com/items/SpearofShojin.png" alt="Spear of Shojin">
                      </div>        
                ...
                <a class="characters-item c5" href="/champions/miss_fortune"><div class="character-wrapper"><img class="character-icon" src="https://rerollcdn.com/characters/Skin/3/MissFortune.png" alt="Miss Fortune"></div>
                  <div class="row popup-info">
                      <div class="col-md-3 col-3 info">
                            <img class="character-icon" src="https://rerollcdn.com/characters/Skin/3/MissFortune.png" alt="Miss Fortune"> 
                            <p>Fortune</p>
                      </div>
                      <div class="col-md-7 col-7 origin-wrap">
                          <div class="d-flex origin">
            ...
            <div class="tier-group">
                ...
                <div class="characters-list">
                <a class="characters-item c3" href="/champions/ashe"><div class="character-wrapper"><img class="character-icon" src="https://rerollcdn.com/characters/Skin/3/Ashe.png" alt="Ashe"></div>
                <div class="row popup-info">
                      <div class="col-md-3 col-3 info">
                      ...
                      <div class="col-md-12 item">
                        ...
                        <img class="character-icon" src="https://rerollcdn.com/items/RabadonsDeathcap.png" alt="Rabadon's Deathcap">
                        <img class="character-icon" src="https://rerollcdn.com/items/SeraphsEmbrace.png" alt="Seraph's Embrace">
                      </div>        

                    </div>
              </a>
                <a class="characters-item c4" href="/champions/chogath"><div class="character-wrapper"><img class="character-icon" src="https://rerollcdn.com/characters/Skin/3/Chogath.png" alt="Chogath"></div>
                <div class="row popup-info">
                      <div class="col-md-3 col-3 info">
                      ...
                      <div class="col-md-12 item">
                        ...
                        <img class="character-icon" src="https://rerollcdn.com/items/GuardianAngel.png" alt="Guardian Angel">
                        <img class="character-icon" src="https://rerollcdn.com/items/Morellonomicon.png" alt="Morellonomicon">
                      </div>        
